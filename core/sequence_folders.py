#!/usr/bin/python3
# from https://github.com/ClementPinard/SfmLearner-Pytorch/blob/master/datasets/sequence_folders.py
...
class SequenceFolder(data.Dataset):
    ...
    def __init__(self, root, seed=None, train=True, sequence_length=3, transform=None, target_transform=None):
        ...
        scene_list_path = '{}/{}'.format(self.root, split) 
        self.scenes = ['{}/{}'.format(self.root,folder[:-1]) for folder in open(scene_list_path)]
    ...
    def crawl_folders(self, sequence_length):
        ...
        shifts.pop(demi_length) # pop at 0 
